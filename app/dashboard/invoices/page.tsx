  ...
  return (
    <>
      ...
      <div className="topnav" id="myTopnav">
        ...
        {/* <!--<a href="#podcasts"><i className="fa fa-briefcase site-nav--icon"></i>Podcasts</a>--> */}
        {/* <!--hamburger menu when screen shrinks--> */}
        {/* <a href="javascript:void(0);" className="icon" onClick="myFunction()">&#9776;</a> */}

        <a href="index.html"><i className="fa fa-home site-nav--icon"></i>Vor English Home</a>
        <a href="articlesmain.html"><i className="fa fa-info site-nav--icon"></i>Articles</a>
        <a href="#tutorials"><i className="fa fa-briefcase site-nav--icon"></i>Tutorials</a>
        <a href="#contact"><i className="fa fa-envelope site-nav--icon"></i>Contact</a>
      </div>

      <div className='containerParagraph'>
        <div className='title'>
          {<br/>}
          <h1>“APOSTROPHE’S ARE OFTEN MISUSED” (Ellen Kersey)</h1>
          {<br/>}
          4 Replies
          .comments-link
          .entry-header
      ...
      <div className="buttons-coll">
        <button className="custom-btn btn-1"> Previous Article </button>
        <button className="custom-btn btn-1"> Articles Home </button>
        <button className="custom-btn btn-1"> Next Article </button>
      </div>
